                    ...
                    {/block}
                      ...
                      {block name='frontend_index_navigation_inline'}
                          {if {config name="compareShow"}}
                              <div class="navigation--entry entry--compare " role="menuitem" id="mySidenav" >
    ...
    {block name="frontend_index_footer"}
        <footer class="footer-main">
            ...
            <div class="jos-footer-bottom">
                ...
                {if $theme.scrollToTopEnabled OR $theme.scrolltop_button_phoneViewport OR $theme.scrolltop_button_tabletViewport}
