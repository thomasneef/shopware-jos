                        ...
                        {block name="frontend_index_footer_column_information_menu_entry"}
                            <li class="navigation--entry" role="menuitem">
                                <a class="navigation--link" href="{if $item.link}{$item.link}{else}{url controller='custom' sCustom=$item.id title=$item.description}{/if}" title="{$item.description|escape}"{if $item.target} target="{$item.target}"{/if}>
                                    {$item.description}
                                    {*<span class="jos-footer-li-icon"><i class="fas fa-square "></i></span><span class="jos-footer-li-text"></span>*}
                                </a>
        ...
        {block name="frontend_index_footer_column_service_payment_content"}
            <div class="column--content">
                <div class="footer--columns--grid-items">
                    ...
                    {if $theme.show_paypal_icon}
                        <div class="footer--columns--items item-paypal grayscale" ></div>
                    {/if}

                    {if $theme.show_paypalrate_icon}
                        <div class="footer--columns--items item-paypalrate grayscale" ></div>
                    {/if}

                    {if $theme.show_nachnahme_icon}
                       <div class="footer--columns--items item-nachnahme grayscale" ></div>
                    {/if}

                    {if $theme.show_vorkasse_icon}
                    ...
                    {if $theme.show_soforuw_icon}
                        <div class="footer--columns--items item-sofort grayscale" ></div>
                    {/if}

                    {if $theme.show_mastercard_icon}
                        <div class="footer--columns--items item-mastercard grayscale" ></div>
                    {/if}

                    {if $theme.show_visa_icon}
                        <div class="footer--columns--items item-visacard grayscale" ></div>
                    {/if}

                    {if $theme.show_giropay_icon}
                        <div class="footer--columns--items item-giropay grayscale" ></div>
                    {/if}

                    {if $theme.show_apple_icon}
                        <div class="footer--columns--items item-applepay grayscale" ></div>
                    {/if}
                    ...
                    {if $theme.show_klarna_invoice_icon}
                        <div class="footer--columns--items item-klarna-invoice grayscale" ></div>
                    {/if}
